import { $n as map, $t as normalizeEvent, Bn as isArrayLike, Bt as Point, Cn as assert, D as Displayable, Dn as createHashMap, E as fromPoints, Et as cubicSubdivide, F as Group$2, Fn as find, Gn as isNumber, Gt as invert, Hn as isFunction, In as hasOwn, Jn as isString, Jt as rotate, Kn as isObject, Kt as matrix_exports, L as getBoundingRect, Ln as indexOf, Mn as eqNaN, Nn as extend, Nt as BoundingRect, On as curry$1, P as zrender_exports, Pn as filter, Pt as boundingRectApplyTransform, Qn as logError, Sn as vector_exports, Tn as clone$2, Ut as create$1, V as Transformable, Vn as isDom, Xt as translate, Zn as keys, Zt as addEventListener, _r as env, _t as parse, bn as set, dr as trim$1, en as stop, er as merge, f as Rect$1, fr as util_exports$1, g as ZRImage, gr as setPlatformAPI, ht as modifyAlpha, jn as each$8, kn as defaults, l as ZRText, m as subPixelOptimizeLine, mn as lerp, nn as transformLocalCoord, nr as mixin, on as applyTransform, or as retrieve, p as subPixelOptimize, qn as isRegExp, qt as mul, r as brushSingle, rn as transformLocalCoordClear, rr as noop, sr as retrieve2, tn as encodeHTML, tr as mergeAll, ut as color_exports, vr as __extends, w as PathProxy, wn as bind$1, x as normalizeRadian, y as Path, yt as stringify, z as parsePercent, zn as isArray$1 } from "./graphic-CjbMicHy.js";
import { $ as OrdinalMeta, $a as mathPI, $i as compressBatches, $n as normalizeCssArray, $t as throttle, Ai as enterEmphasis, An as box, At as registerPostUpdate, B as OrdinalScale, Bn as sizeCalculable, Bt as createSymbol, C as AxisModelCommonMixin, Ca as queryReferringComponents, Cn as registerInternalOptionCreator, Cr as XY$2, Ct as registerAction, Da as deprecateLog, Di as enableHoverEmphasis, Dn as ComponentModel, Dt as registerLoading, E as getAxisRawValue, En as tokens, Et as registerLayout, Ft as registerUpdateLifecycle, Gn as simpleCoordSysInjectionProvider, Hi as SERIES_LAYOUT_BY_COLUMN, Ht as normalizeSymbolSize, Ia as asc$1, In as getLayoutParams, Ir as getShapeClass, It as registerVisual, J as isTimeScale, Ja as mathAbs, Jn as convertToColorString, Jr as retrieveZInfo, Jt as getItemVisualFromData, Ki as getECData, Kt as findEventDispatcher, La as getAcceptableTickPrecision, Li as setStatesStylesFromModel, Ln as getLayoutRect, Lr as getTransform, Lt as setCanvasCreator, M as makeLabelFormatter, Ma as throwError, Mi as leaveBlur, Mn as createBoxLayoutReference, Mr as expandOrShrinkRect, Mt as registerProcessor, Na as warn, Ni as leaveEmphasis, Nt as registerTheme, O as getTickValueOutermost, On as LOCATION_PARAMS, Or as createIcon, Ot as registerMap, Pi as setAsHighDownDispatcher, Pn as getBoxLayoutParams, Pt as registerTransform, Q as initLinearScaleMapper, Qa as mathMin$1, Qi as clearTmpModel, Qr as transformDirection, Qt as createOrUpdate, Ri as toggleHoverEmphasis, Rn as mergeLayoutParam, Rr as graphic_exports$1, Rt as version, Sa as queryDataIndex, Si as clonePath, Sn as getDecalFromPalette, Sr as WH$2, St as init, T as determineAxisType, Tr as calcZ2Range, Tt as registerCustomSeries, Ua as isNullableNumberFinite, Un as injectCoordSysByOption, Ut as symbolBuildProxies, Va as getPrecision, Vr as linePolygonIntersect, Vt as normalizeSymbolOffset, Wr as mergePath, Wt as getCachePerECPrepare, X as enableScaleMapperFreeze, Xa as mathFloor, Xi as MULTIPLE_REFERRING, Xn as formatTpl, Xt as setItemVisualFromData, Y as decorateScaleMapper, Ya as mathCeil, Yi as ListIterator, Yr as setTooltipConfig, Yt as getVisualFromData, Za as mathMax$1, Zi as SINGLE_REFERRING, Zn as formatTplSimple, Zr as subPixelOptimizeLine$1, Zt as clear$1, _a as mappingToExists, _i as Polygon, _r as getFont, _t as dispose, a as parseGeoJSON, aa as getDataItemValue, ao as parsePositionSizeOption, ar as getScaleBreakHelper, b as eachSeriesOnAxisOnKey, ba as preParseFinder, bn as normalizeTooltipFormatResult, br as setLabelStyle, bt as getInstanceById, c as contain, ci as updateProps$1, cn as createTooltipMarkup, cr as getLocaleModel, d as scaleCalcNiceDirectly, da as isNameSpecified, dn as SourceManager, do as round$1, dr as inheritDefaultOption, dt as PRIORITY, ea as convertOptionIdName, ei as traverseUpdateZ, en as ChartView, eo as mathRound, er as toCamelCase, fa as isValidBoundsForExtent, fi as LinearGradient, fn as disableTransformOptionMerge, fr as Model, ft as connect, g as associateSeriesWithAxis, gi as Polyline, gn as parseDataValue, gr as createTextStyle, gt as disconnect, ha as makeInternalComponentId, hi as Line, hn as getRawValueParser, ht as disConnect, ia as ensureExtentAscSimply, ii as isElementRemoved, in as SeriesModel, io as parsePercent$1, ja as makePrintable, jn as copyLayoutParams, jt as registerPreprocessor, k as isAxisOnBand, ka as error, ki as enterBlur, kt as registerPostInit, l as scaleCalcNice, la as initExtentForUnion, ln as getPaddingFromTooltipModel, lo as reformIntervals, lr as registerLocale, lt as DataDiffer, m as scaleRawExtentInfoCreate, ma as makeInner, mn as createFilterComparator, mr as animateLabelValue, mt as dependencies, n as calcBandWidth, na as createSimpleOverallStageHandler2, ni as getOldStyle, nn as ComponentView, nt as getStackedDimension, on as TooltipMarkupStyleCreator, ot as SeriesData, p as registerAxisContainShapeHandler, pa as makeCallOnlyOnce, pn as SortOrderComparator, pt as dataTool, q as isOrdinalScale, qa as linearMap$2, ra as defaultEmphasis, ri as initProps, rn as SERIES_UNIVERSAL_TRANSITION_PROP, ro as parseDate, rr as format, rt as isDimensionStacked, sa as getTooltipRenderMode, sn as buildTooltipMarkup, sr as registerScaleBreakHelperImpl, t as Axis, ta as createSimpleOverallStageHandler, ti as getAnimationConfig, tr as windowOpen, ur as getUID, ut as use, v as eachAxisOnKey, va as normalizeToArray, vi as Ring, vr as getLabelStatesModels, vt as getCoordinateSystemDimensions, w as createScaleByModel, wa as removeDuplicates, wr as applyTransform$1, wt as registerCoordinateSystem, xi as Circle, xt as getMap, ya as parseFinder$1, yi as Sector, yn as DataFormatMixin, yr as labelInner, yt as getInstanceByDom, zn as positionElement, zr as groupTransition, zt as createOrUpdatePatternFromDecal } from "./Axis-YSh05Grs.js";
import { a as util_exports, c as time_exports, i as extendSeriesModel, l as number_exports, n as extendComponentModel, o as format_exports, r as extendComponentView, s as graphic_exports, t as extendChartView, u as helper_exports } from "./api-C9t3HVBA.js";
import { $ as collect, A as install$37, At as getLabelLineStatesModels, B as viewCoordSysSetViewRect, C as sliderMove, Ct as SymbolDraw, D as install$38, Dt as newLabelLayoutWithGeometry, E as install$39, Et as labelLayoutApplyTranslation, F as View, G as COMPONENT_TYPE_SINGLE_AXIS, H as install$34, I as viewCoordSysCopyBoundingRect, J as SingleAxisModel, K as COORD_SYS_TYPE_SINGLE, L as viewCoordSysCopyOverallMatrix, M as install$36, Mt as updateLabelLinePoints, N as install$35, O as injectThumbnailBridge, Ot as restoreIgnore, P as install$53, Q as AxisView, R as viewCoordSysCopyTrans, S as BrushController, St as isCoordinateSystemType, T as install$40, Tt as labelIntersect, U as install$33, V as RoamController, W as installScatterJitter, X as rectCoordAxisBuildSplitArea, Y as install$29, Z as rectCoordAxisHandleRemove, _ as install$42, _t as getAxisBreakHelper, a as applyUpdateTransition, at as install$31, b as makeRectIsTargetByCursor, bt as convertFromEC4CompatibleStyle, c as install$51, ct as createBandWidthBasedAxisContainShapeHandler, d as install$48, dt as layout$1, et as getAxisInfo$1, f as install$47, ft as AxisBuilder, g as install$43, gt as registerAction$1, h as install$44, i as applyLeaveTransition, it as install$32, j as VisualMapping, jt as setLabelLineStyle, k as LineDraw, kt as shiftLayoutOnXY, l as install$50, lt as makeAxisStatKey2, m as install$45, mt as AXIS_BREAK_EXPAND_ACTION_TYPE, n as applyKeyframeAnimation, nt as registerLegacyGridContainLabelImpl, o as isTransitionAll, ot as getStartValue, p as install$46, r as stopPreviousKeyframeAnimationAndRestore, rt as axisModelCreator, s as updateLeaveTo, st as requireAxisStatisticsForBaseBar, t as install$52, tt as makeKey, u as install$49, ut as getCartesianAxisHashKey, v as install$54, vt as registerAxisBreakHelperImpl, w as install$41, wt as hideOverlap, x as makeRectPanelClipPath, xt as isEC4CompatibleStyle, y as makeLinearBrushOtherExtent, yt as install$30, z as viewCoordSysSetBoundingRect } from "./install-CkV6v-7x.js";
import { n as install$56, t as install$55 } from "./installCanvasRenderer-DPUoViyq.js";
...
var LabelManager = function() {
	...
	*/
	...
	LabelManager.prototype.layout = function(api) {
		...
		var height = api.getHeight();
		var labelList = [];
		each$8(this._labelList, function(inputItem) {
	...
	*/
	LabelManager.prototype.processLabelsOverall = function() {
		var _this = this;
		each$8(this._chartViewList, function(chartView) {
			var seriesModel = chartView.__model;
...
var BaseAxisPointer = function() {
	...
	*/
	BaseAxisPointer.prototype.createLabelEl = function(group, elOption, axisModel, axisPointerModel) {
		if (elOption.label) {
			var labelEl = inner$10(group).labelEl = new ZRText(clone$1(elOption.label));
			group.add(labelEl);
...
function createMatrixCell(xyLocator, matrixModel, group, ecModel, cellOption, parentItemStyleModel, parentLabelModel, parentCellModel, shape, textValue, zrCellDefault, tooltipOption, targetType) {
	...
	if (textValue != null) {
		...
		setLabelStyle(cellRect, { normal: _tmpCellLabelModel }, {
			...
			layoutRect: clone$2(cellRect.shape)
		});
	...
	*/
	GraphicComponentView.prototype._clear = function() {
		...
		elMap.each(function(el) {
			removeEl$1(el, inner$6(el).option, elMap, _this._lastGraphicModel);
		});
		this._elMap = createHashMap();
	};
	...
	each$4(stateList, function(state) {
		...
		each$4(option[state], function(visualData, visualType) {
			...
			if (visualType === "opacity") {
				mappingOption = clone$2(mappingOption);
...
function replaceVisualOption(thisOption, newOption, keys) {
	...
	has && each$8(keys, function(key) {
		if (newOption.hasOwnProperty(key) && hasKeys(newOption[key])) thisOption[key] = clone$2(newOption[key]);
...
function brushVisual(ecModel, api, payload) {
	...
	ecModel.eachComponent({ mainType: "brush" }, function(brushModel, brushIndex) {
		var thisBrushSelected = {
			...
			areas: clone$2(brushModel.areas),
			selected: []
		};
...
get: function(visualType, key, isCategory) {
	var value = clone$2((defaultOption[visualType] || {})[key]);
	...
	VisualMapModel.prototype.completeVisualOption = function() {
		...
		function completeController(controller) {
			...
			each$2(this.stateList, function(state) {
				...
				if (visuals.symbol == null) visuals.symbol = symbolExists && clone$2(symbolExists) || (isCategory ? defaultSymbol : [defaultSymbol]);
				if (visuals.symbolSize == null) visuals.symbolSize = symbolSizeExists && clone$2(symbolSizeExists) || (isCategory ? itemSize[0] : [itemSize[0], itemSize[0]]);
...
var PiecewiseModel = function(_super) {
	...
	PiecewiseModel.prototype.optionUpdated = function(newOption, isInit) {
		...
		this.resetVisual(function(mappingOption, state) {
			if (mode === "categories") {
				...
				mappingOption.categories = clone$2(categories);
			} else {
				mappingOption.dataExtent = this.getExtent();
	...
	*/
	PiecewiseModel.prototype.setSelected = function(selected) {
		this.option.selected = clone$2(selected);
	};
	/**
	* @override
	*/
...
var PiecewiseVisualMapView = function(_super) {
	...
	*/
	...
	PiecewiseVisualMapView.prototype._onItemClick = function(piece) {
		...
		var selected = clone$2(option.selected);
...
function ariaVisual(ecModel, api) {
	...
	var defaultOption = clone$2(DEFAULT_OPTION);
...
function flattenDataDiffItems(list) {
	var items = [];
	each$8(list, function(seriesInfo) {
...
function transitionBetween(oldList, newList, api) {
	...
	*/
	...
	each$8(oldDiffItems, function(item) {
	...
	new DataDiffer(oldDiffItems, newDiffItems, createKeyGetter(true, useId), createKeyGetter(false, useId), null, "multiple").update(updateOneToOne).updateManyToOne(function(newIndex, oldIndices) {
		...
		if (newEl) {
			...
			if (oldElsList.length) {
				each$8(oldElsList, function(oldEl) {
					stopAnimation(oldEl);
					removeEl(oldEl);
				});
				hasMorphAnimation = true;
		...
		if (newElsList.length) {
			each$8(newElsList, function(newEl) {
			...
			} else each$8(newElsList, function(newEl) {
	...
	if (hasMorphAnimation) each$8(newList, function(_a) {
...
function convertArraySeriesKeyToString(seriesKey) {
	if (isArray$1(seriesKey)) return seriesKey.sort().join(",");
	return seriesKey;
}
...
function findTransitionSeriesBatches(globalStore, params) {
	...
	each$8(globalStore.oldSeries, function(series, idx) {
		...
		if (isArray$1(transitionKey)) each$8(transitionKey, function(key) {
	...
	each$8(params.updatedSeries, function(series) {
		if (series.isUniversalTransitionEnabled() && series.isAnimationEnabled()) {
			...
			} else if (isArray$1(transitionKey)) {
				checkTransitionSeriesKeyDuplicated(transitionKeyStr);
				var oldSeries_1 = [];
...
function transitionSeriesFromOpt(transitionOpt, globalStore, params, api) {
	var from = [];
	var to = [];
	each$8(normalizeToArray(transitionOpt.from), function(finder) {
	...
	each$8(normalizeToArray(transitionOpt.to), function(finder) {
...
function installUniversalTransition(registers) {
	registers.registerUpdateLifecycle("series:beforeupdate", function(ecMOdel, api, params) {
		each$8(normalizeToArray(params.seriesTransition), function(transOpt) {
			each$8(normalizeToArray(transOpt.to), function(finder) {
	...
	registers.registerUpdateLifecycle("series:transition", function(ecModel, api, params) {
		...
		if (globalStore.oldSeries && params.updatedSeries && params.optionChanged) {
			...
			if (transitionOpt) each$8(normalizeToArray(transitionOpt), function(opt) {
				transitionSeriesFromOpt(opt, globalStore, params, api);
			});
			else {
				var updateBatches_1 = findTransitionSeriesBatches(globalStore, params);
				each$8(updateBatches_1.keys(), function(key) {
...
function updateAxisBreakGapReal(brkMapper, scaleExtent) {
	...
	each$8(brkMapper.breaks, function(brk) {
	...
	each$8(brkMapper.breaks, function(brk) {
		var gapParsed = brk.gapParsed;
		if (gapParsed.type === "tpPrct") brk.gapReal = gapPrctSum !== 0 ? mathMax$1(prctBrksGapRealSum, 0) * gapParsed.val / gapPrctSum : 0;
...
function clampBreakByExtent(brk, scaleExtent) {
	var vmin = mathMax$1(brk.vmin, scaleExtent[0]);
	var vmax = mathMin$1(brk.vmax, scaleExtent[1]);
...
function parseAxisBreakOption(breakOptionList, scale, opt) {
	...
	each$8(breakOptionList, function(brkOption) {
		...
		if (opt && opt.noNegative) each$8(["vmin", "vmax"], function(se) {
			if (parsedBrk[se] < 0) {
	...
	each$8(parsedBreaks, function(brk, idx) {
		if (lastEnd > brk.vmin) {
...
function retrieveAxisBreakPairs(itemList, getVisualAxisBreak, returnIdx) {
	var idxPairList = [];
	each$8(itemList, function(el, idx) {
	...
	var result = [];
	each$8(idxPairList, function(idxPair) {
...
function getTicksBreakOutwardTransform(scale, tick, outermostBreaks, lookup) {
	...
	var parsedBreak = {
		...
		breakOption: brk.breakOption,
		gapParsed: clone$2(originalBrkItem.gapParsed),
		gapReal: brk.gapReal
	};
	return {
...
function resetCacheVisualRemoveFlag(visualList) {
	each$8(visualList, function(item) {
...
function rectCoordBuildBreakAxis(axisGroup, axisView, axisModel, coordSysRect, api) {
	...
	var group = new Group$2({ ignoreModelZ: true });
...
function adjustBreakLabelPair(axisInverse, axisRotation, layoutPair) {
	...
	var labelPairStTrans = map(layoutPair, function(layout) {
		return layout.transform ? mul(create$1(), axisStTrans, layout.transform) : axisStTrans;
	});
...
function updateModelAxisBreak(model, payload) {
	var result = { breaks: [] };
	each$8(payload.breaks, function(inputBrk) {
		if (!inputBrk) return;
